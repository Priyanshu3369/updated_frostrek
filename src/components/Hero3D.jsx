  ...
  return (
    <div className="relative w-full h-[350px] md:h-[500px]">
      ...
      <motion.div
        ...
        className="absolute top-[-74%] md:top-[5%] right-[-2%] md:right-[-10%] z-20 max-w-[280px] md:max-w-[320px] cursor-grab active:cursor-grabbing rounded-2xl bg-gradient-to-br from-[#06060C]/95 via-[#0B0B0E]/95 to-[#06060C]/95 backdrop-blur-xl border-2 border-cyan-400/40 px-4 py-3 text-sm text-slate-200 shadow-[0_20px_60px_rgba(0,255,255,0.25),0_0_40px_rgba(168,85,247,0.15)] hover:border-purple-400/50 hover:shadow-[0_20px_70px_rgba(0,255,255,0.35),0_0_50px_rgba(168,85,247,0.25)] transition-all duration-500 group"
        initial={{ opacity: 0, scale: 0.8, y: 20 }}
        animate={{ opacity: 1, scale: 1, y: 0 }}
        transition={{ type: "spring", stiffness: 200, damping: 20 }}
        whileHover={{ scale: 1.03, rotate: 0.5 }}
      >
        <span className="absolute -bottom-2.5 md:-bottom-2.5 left-12 md:left-12 h-5 w-5 rotate-45 md:rotate-45 bg-gradient-to-br from-[#06060C] to-[#0B0B0E] border-r-2 border-b-2 border-cyan-400/40" />
